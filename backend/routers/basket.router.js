...
router.post("/removeById", async (req, res) => {
  response(res, async () => {
    ...
    res.json({ message: "Ürün silme işlemi başarı ile gerçekleştirildi!" });
  });
});
...
router.post("/getCount", async (req, res) => {
  response(res, async () => {
    ...
    // Boolean, string, number vs. Bir objeye atamadan angular'a gönderirsek angular hata olarak algılar
